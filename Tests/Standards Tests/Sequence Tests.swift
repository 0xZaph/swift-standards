...
extension PerformanceTests {
    ...
    struct `Sequence - Performance` {
        ...
        @Test(.timed(threshold: .milliseconds(50), maxAllocations: 2_000_000))
        ...
        @Test(.timed(threshold: .milliseconds(70), maxAllocations: 3_000_000))
        ...
        @Test(.timed(threshold: .milliseconds(40), maxAllocations: 2_000_000))
