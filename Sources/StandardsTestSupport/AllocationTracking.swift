...
extension StandardsTestSupport {
    ...
    static func captureAllocationStats() -> Performance.AllocationStats {
    ...
    #if os(macOS) || os(iOS) || os(watchOS) || os(tvOS)
    private static func captureAllocationStatsDarwin() -> Performance.AllocationStats {
    ...
    #if os(Linux)
    private static func captureAllocationStatsLinux() -> Performance.AllocationStats {
