...
extension Collections.Set.Ordered.Storage {
    @usableFromInline
    var count: Int {
        elements.count
    }
...
extension Collections.Set.Ordered.Storage {
    @usableFromInline
    func copy() -> Collections.Set.Ordered<Element>.Storage {
        Collections.Set.Ordered<Element>.Storage(elements: elements, indices: indices)
    }
}
...
extension Collections.Set.Ordered.Storage: @unchecked Sendable where Element: Sendable {}
