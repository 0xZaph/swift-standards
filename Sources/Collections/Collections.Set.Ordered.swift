...
extension Collections.Set {
    ...
    public struct Ordered<Element: Hashable> {
        @usableFromInline
        var storage: Storage
...
extension Collections.Set.Ordered: Sendable where Element: Sendable {}

// MARK: - Equatable

extension Collections.Set.Ordered: Equatable {
    @inlinable
...
extension Collections.Set.Ordered: Hashable {
    @inlinable
...
extension Collections.Set.Ordered: ExpressibleByArrayLiteral {
    @inlinable
...
extension Collections.Set.Ordered: CustomStringConvertible {
