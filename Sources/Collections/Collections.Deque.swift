...
extension Collections.Deque: Sendable where Element: Sendable {}

// MARK: - Equatable

extension Collections.Deque: Equatable where Element: Equatable {
    @inlinable
...
extension Collections.Deque: Hashable where Element: Hashable {
    @inlinable
...
extension Collections.Deque: ExpressibleByArrayLiteral {
    @inlinable
...
extension Collections.Deque: CustomStringConvertible {
