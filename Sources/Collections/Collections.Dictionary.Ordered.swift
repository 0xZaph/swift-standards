...
extension Collections.Dictionary {
    ...
    public struct Ordered<Key: Hashable, Value> {
        @usableFromInline
        var _keys: Collections.Set.Ordered<Key>
        ...
        @inlinable
        public init() {
            self._keys = Collections.Set.Ordered<Key>()
...
extension Collections.Dictionary.Ordered: Sendable where Key: Sendable, Value: Sendable {}

// MARK: - Equatable

extension Collections.Dictionary.Ordered: Equatable where Value: Equatable {
    @inlinable
...
extension Collections.Dictionary.Ordered: Hashable where Value: Hashable {
    @inlinable
...
extension Collections.Dictionary.Ordered: CustomStringConvertible {
